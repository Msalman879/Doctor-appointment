document.addEventListener('DOMContentLoaded', function () {
   ...
   var links = document.querySelectorAll('nav ul li a');
    ...
    if (!localStorage.getItem('visited')) {
        setTimeout(function () {
            alert('Welcome to our Online Doctor Appointment System!');
    ...
    var doctorItems = document.querySelectorAll('#doctor-categories ul li a');
    doctorItems.forEach(item => {
        item.addEventListener('click', function (e) {
            e.preventDefault();
            const doctorName = this.previousElementSibling.previousElementSibling.textContent;
            const doctorSpecialty = this.previousElementSibling.textContent;
            openDoctorModal(doctorName, doctorSpecialty);
        });
    });
